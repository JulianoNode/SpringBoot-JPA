...
import com.Strart.domain.Especialidade;
import com.Strart.service.EspecialidadeService;
...
public class EspecialidadeController {
	...
	public String salvar(Especialidade especialidade, RedirectAttributes attr) {
		...
		attr.addFlashAttribute("sucesso", "Operação realizada com sucesso!");
            ...
            attr.addFlashAttribute("aviso", "ATENÇÂO! Operação não realizada! Essa ESPECIALIDADE já está cadastrada!");
	...
	// Listar um tabela de especialidade na tela de * afiliado -> cadastro.HTML *
	@GetMapping("/datatables/server/afiliado/{id}")
	public ResponseEntity<?> getEspecialidadesPorAfiliado(@PathVariable("id") Long id, 
				HttpServletRequest request) {
		
		return ResponseEntity.ok(service.buscarEspecialidadesPorAfiliado(id, request)); 
	}
}
