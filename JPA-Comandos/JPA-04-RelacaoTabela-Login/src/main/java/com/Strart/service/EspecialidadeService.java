...
import com.Strart.repository.EspecialidadeRepository;
...
public class EspecialidadeService {
	...
	@Transactional(readOnly = true)
	public Map<String, Object> buscarEspecialidadesPorAfiliado(Long id, HttpServletRequest request) {
		datatables.setRequest(request);
		datatables.setColunas(DatatablesColunas.ESPECIALIDADES);
		Page<Especialidade> page = repository.findByIdAfiliado(id, datatables.getPageable()); 
		return datatables.getResponse(page);
	}
